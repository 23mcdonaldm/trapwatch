...
export const MOCK_GAMES: Game[] = [
  {
    ...
    isHomeFavorite: true,
    odds: { spread: '-7.5', moneyline: '-340', total: '48.5' },
  ...
  },
  {
    ...
    isHomeFavorite: true,
    odds: { spread: '-12.5', moneyline: '-900', total: '225.5' },
  ...
  },
  {
    ...
    isHomeFavorite: true,
    odds: { spread: '-14', moneyline: '-650', total: '52' },
  ...
  },
  {
    ...
    isHomeFavorite: true,
    odds: { spread: '-1.5', moneyline: '-220', total: '6.5' },
  ...
  },
  {
    ...
    isHomeFavorite: true,
    odds: { spread: '-3.5', moneyline: '-175', total: '49' },
